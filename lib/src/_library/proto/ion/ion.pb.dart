...
class Track extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'simulcast',
        entryClassName: 'Track.SimulcastEntry',
...
class SessionEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ion'),
      createEmptyInstance: create)
    ..e<SessionEvent_State>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'state',
        $pb.PbFieldType.OE,
        defaultOrMaker: SessionEvent_State.ADD,
        valueOf: SessionEvent_State.valueOf,
        enumValues: SessionEvent_State.values)
    ..aOS(3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nid')
  ...
  factory SessionEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SessionEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  SessionEvent copyWith(void Function(SessionEvent) updates) =>
      super.copyWith((message) => updates(message as SessionEvent))
          as SessionEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set state(SessionEvent_State v) {
    setField(2, v);
  }
...
class StreamEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<StreamEvent_State>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'state',
        $pb.PbFieldType.OE,
        defaultOrMaker: StreamEvent_State.ADD,
        valueOf: StreamEvent_State.valueOf,
        enumValues: StreamEvent_State.values)
    ..aOS(3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nid')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sid')
  ...
  factory StreamEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StreamEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  StreamEvent copyWith(void Function(StreamEvent) updates) =>
      super.copyWith((message) => updates(message as StreamEvent))
          as StreamEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static StreamEvent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<StreamEvent>(create);
  static StreamEvent? _defaultInstance;

  @$pb.TagNumber(2)
  StreamEvent_State get state => $_getN(0);
  @$pb.TagNumber(2)
  set state(StreamEvent_State v) {
    setField(2, v);
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<PeerEvent_State>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'state',
        $pb.PbFieldType.OE,
        defaultOrMaker: PeerEvent_State.JOIN,
        valueOf: PeerEvent_State.valueOf,
        enumValues: PeerEvent_State.values)
    ..aOM<Peer>(
