...
final $typed_data.Uint8List signalRequestDescriptor = $convert.base64Decode(
    'Cg1TaWduYWxSZXF1ZXN0Eg4KAmlkGAEgASgJUgJpZBImCgRqb2luGAIgASgLMhAuc2Z1LkpvaW5SZXF1ZXN0SABSBGpvaW4SIgoLZGVzY3JpcHRpb24YAyABKAxIAFILZGVzY3JpcHRpb24SKAoHdHJpY2tsZRgEIAEoCzIMLnNmdS5Ucmlja2xlSABSB3RyaWNrbGVCCQoHcGF5bG9hZA==');
...
final $typed_data.Uint8List signalReplyDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List joinRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List joinReplyDescriptor = $convert.base64Decode(
    'CglKb2luUmVwbHkSIAoLZGVzY3JpcHRpb24YASABKAxSC2Rlc2NyaXB0aW9u');
...
final $typed_data.Uint8List trickleDescriptor = $convert.base64Decode(
    'CgdUcmlja2xlEisKBnRhcmdldBgBIAEoDjITLnNmdS5Ucmlja2xlLlRhcmdldFIGdGFyZ2V0EhIKBGluaXQYAiABKAlSBGluaXQiJwoGVGFyZ2V0Eg0KCVBVQkxJU0hFUhAAEg4KClNVQlNDUklCRVIQAQ==');
