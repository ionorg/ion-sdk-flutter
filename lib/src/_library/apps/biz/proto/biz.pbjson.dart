...
final $typed_data.Uint8List joinDescriptor = $convert.base64Decode(
    'CgRKb2luEh0KBHBlZXIYASABKAsyCS5pb24uUGVlclIEcGVlchIUCgV0b2tlbhgCIAEoCVIFdG9rZW4=');
...
final $typed_data.Uint8List joinReplyDescriptor = $convert.base64Decode(
    'CglKb2luUmVwbHkSGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIWCgZyZWFzb24YAiABKAlSBnJlYXNvbg==');
...
final $typed_data.Uint8List leaveDescriptor =
    $convert.base64Decode('CgVMZWF2ZRIQCgN1aWQYASABKAlSA3VpZA==');
...
final $typed_data.Uint8List leaveReplyDescriptor =
    $convert.base64Decode('CgpMZWF2ZVJlcGx5EhYKBnJlYXNvbhgBIAEoCVIGcmVhc29u');
...
final $typed_data.Uint8List signalRequestDescriptor = $convert.base64Decode(
    'Cg1TaWduYWxSZXF1ZXN0Eh8KBGpvaW4YASABKAsyCS5iaXouSm9pbkgAUgRqb2luEiIKBWxlYXZlGAIgASgLMgouYml6LkxlYXZlSABSBWxlYXZlEiAKA21zZxgEIAEoCzIMLmlvbi5NZXNzYWdlSABSA21zZ0IJCgdwYXlsb2Fk');
...
final $typed_data.Uint8List signalReplyDescriptor = $convert.base64Decode(
    '');
