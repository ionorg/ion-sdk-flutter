...
class Join extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Peer>(1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'peer',
        subBuilder: $1.Peer.create)
    ..aOS(
        2,
...
enum SignalRequest_Payload { join, leave, msg, notSet }
...
class SignalRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2, 4])
    ..aOM<Join>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'join',
        subBuilder: Join.create)
    ..aOM<Leave>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'leave',
        subBuilder: Leave.create)
    ..aOM<$1.Message>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'msg',
...
class SignalReply extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignalReply',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'biz'),
    ...
    ..oo(0, [1, 2, 3, 4, 5])
    ..aOM<JoinReply>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'joinReply',
        protoName: 'joinReply', subBuilder: JoinReply.create)
    ..aOM<LeaveReply>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'leaveReply',
        protoName: 'leaveReply', subBuilder: LeaveReply.create)
    ..aOM<$1.PeerEvent>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'peerEvent',
        protoName: 'peerEvent', subBuilder: $1.PeerEvent.create)
    ..aOM<$1.StreamEvent>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streamEvent',
        protoName: 'streamEvent', subBuilder: $1.StreamEvent.create)
  ...
  SignalReply copyWith(void Function(SignalReply) updates) =>
      super.copyWith((message) => updates(message as SignalReply))
          as SignalReply; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set streamEvent($1.StreamEvent v) {
    setField(4, v);
  }
